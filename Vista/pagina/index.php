...
<body>
    <nav class="navbar bg-primary navbar-expand-lg navbar-light py-4 text-center">
        <div class="container px-4 px-lg-5">
            ...
            <a class="navbar-brand text-white" href="registracion.php">Registrarse</a>
            <a class="navbar-brand text-white" href="../sesion/iniciarSesion.php">Iniciar Sesion</a>
        </div>
    </nav>
    <section>
        ...
        <div class="container">
            <h1 class="fw-bolder text-center py-5">Quienes Somos?</h1>
        </div>
        <div class="opacity-bg text-center container">
    ...
    <footer class="py-3 mt-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Patricio Rubio - Victoria Perez - Sergio Valicenti</p>
