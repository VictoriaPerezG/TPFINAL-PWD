...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = ''; // Correo de origen que se usa para el envio del correo  
    $mail->Password = ''; // Contraseña de aplicación en Gmail
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Utiliza STARTTLS para el protocolo de seguridad
    $mail->Port = 587; 
    $mail->setFrom('', 'Victoria PG'); //Correo que manda el mail
    $mail->addAddress(''); // Correo de destino 
    $mail->isHTML(true);
